...
<style>
    ...
    /* Restore Clean Minimalism - Hide streamlit overhead */
    [data-testid="stSidebar"], [data-testid="stSidebarNav"], .stSidebar, section[data-testid="stSidebar"] {
